...
vim.keymap.set('n', '<F6>', '<leader>dj',  { remap = true, silent = true, desc = 'debug callstack down' })
vim.keymap.set('n', '<F7>', '<leader>dk',  { remap = true, silent = true, desc = 'debug callstack up' })
vim.keymap.set('n', '<F8>', '<leader>dc',  { remap = true, silent = true, desc = 'debug run continue' })
vim.keymap.set('n', '<F9>', '<leader>dC',  { remap = true, silent = true, desc = 'debug run to cursor' })
vim.keymap.set('n', '<F10>', '<leader>dO', { remap = true, silent = true, desc = 'debug step over' })
vim.keymap.set('n', '<F11>', '<leader>di', { remap = true, silent = true, desc = 'debug step into' })
vim.keymap.set('n', '<F12>', '<leader>do', { remap = true, silent = true, desc = 'debug step out' })
